...
def test_calculate_text_similarity_different():
    """בדיקת דמיון בין טקסטים שונים לגמרי"""
    text1 = "Hello World"
...
def test_calculate_text_similarity_partial():
    """בדיקת דמיון בין טקסטים עם חפיפה חלקית"""
    text1 = "Hello World"
    text2 = "Hello Python"
    similarity = calculate_text_similarity(text1, text2)
...
def test_calculate_text_similarity_case_insensitive():
    """בדיקת דמיון ללא תלות באותיות גדולות/קטנות"""
    text1 = "Hello World"
    text2 = "hello world"
    similarity = calculate_text_similarity(text1, text2)
    assert similarity == 1.0
